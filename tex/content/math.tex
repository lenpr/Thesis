...
\begin{figure}[ht]
\centering
\includegraphics[width=0.70\textwidth]{topology_examples.jpg}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.4\textwidth]{loops_handles.jpg}
...
\end{equation}
\dots \,where $\hat{v}_{i}$ is the simplex that gets deleted from the sequence.
...
One goal for this thesis was, not only to preserve, but to control topology.
